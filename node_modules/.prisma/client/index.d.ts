  ...
  */
  ...
  export interface PostDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
     ...
     * 
     * // Only select the `length`
     * const postWithLengthOnly = await prisma.post.findMany({ select: { length: true } })
     * 
    **/
  ...
  export type FriendGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof Friend ? Friend[P] : never
  } 
    : Friend
  : Friend
  ...
  export interface FriendDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Friend'> extends True ? CheckSelect<T, Prisma__FriendClient<Friend>, Prisma__FriendClient<FriendGetPayload<T>>> : CheckSelect<T, Prisma__FriendClient<Friend | null, null>, Prisma__FriendClient<FriendGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Friend'> extends True ? CheckSelect<T, Prisma__FriendClient<Friend>, Prisma__FriendClient<FriendGetPayload<T>>> : CheckSelect<T, Prisma__FriendClient<Friend | null, null>, Prisma__FriendClient<FriendGetPayload<T> | null, null>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__FriendClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
